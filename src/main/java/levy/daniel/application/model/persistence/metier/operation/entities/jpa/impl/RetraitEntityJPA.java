 ...
 *
 */
@Entity(name="RetraitEntityJPA")
@Table(name="RETRAITS", schema="PUBLIC")
@PrimaryKeyJoinColumn(
		foreignKey=@ForeignKey(name="FK_ABSTRACTOPERATION_RETRAIT")
		, name="ID_RETRAIT")
public class RetraitEntityJPA extends AbstractOperationEntityJPA {
	...
	private static final Log LOG = LogFactory.getLog(RetraitEntityJPA.class);
...
} // FIN DE LA CLASSE RetraitEntityJPA.--------------------------------------
